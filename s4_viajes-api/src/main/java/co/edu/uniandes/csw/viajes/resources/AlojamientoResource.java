...
public class AlojamientoResource {
     ...
     *
     * @param pAlojamiento {@link AlojamientoDTO} - EL alojamiento que se desea
     * guardar.
     * @return JSON {@link AlojamientoDTO} - El alojamiento guardado con el
     * atributo id.
     */
    @POST
    public AlojamientoDTO createAlojamiento(AlojamientoDTO pAlojamiento) {
//        LOGGER.log(Level.INFO, "AlojamientoResource createAlojamiento: input: {0}", pAlojamiento.toString());
//        AlojamientoEntity alojamientoEntity = pAlojamiento.toEntity(); 
//        AlojamientoDTO nuevoAlojamientoDTO = new AlojamientoDTO(alojamientoLogic.createAlojamiento(alojamientoEntity));  
...
//        LOGGER.info("AlojamientoResource getAlojamientos: input: void");
        List<AlojamientoEntity> listaAlojamientos = new ArrayList<>();
//        listaAlojamientos =  alojamientoLogic.getAlojamientos();
...
//        }
        AlojamientoDTO alojamientoRetorno = new AlojamientoDTO(alojamientoEntity);
//        LOGGER.log(Level.INFO, "BookResource getBook: output: {0}", alojamientoRetorno.toString());
        return alojamientoRetorno;
    }
