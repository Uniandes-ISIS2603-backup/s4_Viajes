...
public class AlojamientoLogic {
     ...
     */
    public AlojamientoEntity createAlojamiento(AlojamientoEntity alojamientoEntity) {
...
//      alojamientos = persistence.findAll();
...
//         alojamientoEntity = persistence.find(alojamientoId);
...
//         newEntity = persistence.update(alojamientoEntity);
